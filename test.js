...
let itemStates = {
    keys: ["tape", "lighter", "rope", "knife", "flute", "drums", "ruler","calculator", "book", "globe", "bat", "spider"],
...
function moveLocation(newLocation) {
    ...
    if (validMoves.includes(newLocation)) {
        ...
        console.log(`You run to the ${locationLookUp[newLocation].name}, ${locationLookUp[newLocation].description}. Items: ${locationLookUp[newLocation].inventory}.  [take + item]`)
